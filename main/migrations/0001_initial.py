    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires_at', models.DateTimeField(choices=[(datetime.datetime(2019, 11, 1, 19, 4, 37, 576434), '10 Minutes'), (datetime.datetime(2019, 11, 2, 18, 54, 37, 576455), '1 Day'), (datetime.datetime(2019, 11, 4, 18, 54, 37, 576459), '3 Days'), (datetime.datetime(2019, 11, 8, 18, 54, 37, 576461), '1 Week'), (datetime.datetime(2019, 11, 15, 18, 54, 37, 576464), '2 Weeks')], default=(datetime.datetime(2019, 11, 1, 19, 4, 37, 576434), '10 Minutes'), verbose_name='Expires in')),
